export default function Hero() {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center px-4 text-center overflow-hidden pt-20">
      <div className="absolute top-1/4 -z-10 w-64 h-64 md:w-96 md:h-96 bg-game-purple/20 blur-[250px] rounded-full animate-pulse" />
      
      <div className="mb-4 px-4 py-2 font-pixel font-bold text-[16px] md:text-[24px] text-game-purple tracking-widest backdrop-blur-sm">
